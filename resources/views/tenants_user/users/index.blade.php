        ...
        <div class="flex justify-between items-center">
            ...
            @else
                <div class="flex items-center space-x-2">
                    <a href="{{ route('unauthorized') }}" class="inline-flex items-center px-4 py-2 bg-gray-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest">
                        Add User
                    </a>
                </div>
            @endif
